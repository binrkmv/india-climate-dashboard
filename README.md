...
## 🚀 Features
* **Granular Filters:** Cascading sidebar options to filter by specific Year, Month, Day, and State.
...
2. **Climate Matrices (ERA5 Reanalysis):** Compressed into an in-memory stream zip archive (`climate_data_india_FINAL.zip`) and served via GitHub Releases. Source: Copernicus Data Space Ecosystem (CDSE).
